...
<gameSystem id="218d-602b-768b-7f56" name="WH30k Fan made 9th Edition" revision="1" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <costTypes>
  ...
  <forceEntries>
    ...
    <forceEntry id="b0ef-1c5e-21fc-3a99" name="Fortification Network (-1 CP)" hidden="false">
      ...
      <constraints>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="01c7-193f-577b-863b" type="max"/>
      </constraints>
      <forceEntries>
  ...
  <entryLinks>
    ...
    <entryLink id="abc2-d5c7-9630-4657" name="Detachment CP" hidden="false" collective="false" import="true" targetId="c547-f608-6310-ed33" type="selectionEntry">
      <categoryLinks>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="be1b-f669-1949-e336" name="Battle Size" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
        <constraint field="selections" scope="roster" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="76c6-5370-e4d8-2658" type="min"/>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="be2f-4e16-db60-f950" type="max"/>
      </constraints>
      <selectionEntryGroups>
        <selectionEntryGroup id="3984-87a8-ed81-02fc" name="Battle Size" hidden="false" collective="false" import="true" defaultSelectionEntryId="e0fb-c150-b08c-6270">
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="76f3-11d8-e5e9-6812" type="min"/>
          ...
          <selectionEntries>
            <selectionEntry id="7466-8dd9-ca3a-79c6" name="1. Combat Patrol (0-50 PL / 0-500 Points)" hidden="false" collective="false" import="true" type="upgrade">
              <costs>
            ...
            <selectionEntry id="955e-6042-a67a-f486" name="2. Incursion (51-100 PL / 501-1000 Points)" hidden="false" collective="false" import="true" type="upgrade">
              <costs>
                <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            ...
            <selectionEntry id="e0fb-c150-b08c-6270" name="3. Strike Force (101-200 PL / 1001-2000 Points)" hidden="false" collective="false" import="true" type="upgrade">
              <costs>
                <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            ...
            <selectionEntry id="57b8-4e25-b673-88d4" name="4. Onslaught (201-300 PL / 2001- 3000 Points)" hidden="false" collective="false" import="true" type="upgrade">
              <costs>
                <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
    ...
    <selectionEntry id="c547-f608-6310-ed33" name="Detachment CP" hidden="false" collective="false" import="true" type="upgrade">
      <modifiers>
            ...
            <conditionGroup type="or">
              <conditionGroups>
                ...
                <conditionGroup type="and">
                  <conditions>
                    <condition field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="26c1-e6bf-4904-500b" type="equalTo"/>
                    <condition field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="b832-8e99-ed24-0091" type="instanceOf"/>
                  </conditions>
                </conditionGroup>
                <conditionGroup type="and">
                  <conditions>
