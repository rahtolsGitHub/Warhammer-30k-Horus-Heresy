...
<gameSystem id="218d-602b-768b-7f56" name="WH30k Fan made 9th Edition" revision="2" battleScribeVersion="2.03" authorName="Lothar" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <comment>BattleScribe Data for the Fan made Warhammer 30k 9th edition.</comment>
  <costTypes>
  ...
  <profileTypes>
    ...
    <profileType id="2324-ae93-2fea-0b85" name="Ability">
      <characteristicTypes>
        <characteristicType id="3117-79f3-eb21-c725" name="Ability"/>
      </characteristicTypes>
    </profileType>
  ...
  <categoryEntries>
    ...
    <categoryEntry id="5142-9e49-4ae3-54f8" name="Master of the Legion" hidden="false">
      <modifiers>
        <modifier type="increment" field="820c-67e3-3574-8e66" value="1.0">
          <repeats>
            <repeat field="9484-733c-9847-f18b" scope="roster" value="1000.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" childId="any" repeats="1" roundUp="false"/>
          </repeats>
        </modifier>
      </modifiers>
      <constraints>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="820c-67e3-3574-8e66" type="max"/>
      </constraints>
    </categoryEntry>
  </categoryEntries>
  <forceEntries>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="be1b-f669-1949-e336" name="Battle Size" hidden="false" collective="false" import="true" type="upgrade">
      ...
      <selectionEntryGroups>
        <selectionEntryGroup id="3984-87a8-ed81-02fc" name="Battle Size" hidden="false" collective="false" import="true" defaultSelectionEntryId="e0fb-c150-b08c-6270">
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="86f9-9298-bb65-f67f" type="max"/>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="f8d0-c757-f17b-7b6c" type="min"/>
          </constraints>
          <selectionEntries>
    ...
    <selectionEntry id="c547-f608-6310-ed33" name="Detachment CP (no Warlord)" hidden="false" collective="false" import="true" type="upgrade">
      ...
      <selectionEntries>
        <selectionEntry id="7517-97c9-abcf-7ee8" name="Command Benefit" hidden="true" collective="false" import="true" type="upgrade">
          ...
          <profiles>
            <profile id="0a3b-49c9-5fbd-97a9" name="Command Benefit" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
              <characteristics>
                <characteristic name="Ability" typeId="3117-79f3-eb21-c725">+1 Command point if every unitin this Detachment is from the same Faction and thatFaction is the same as your WARLORD’s Detachment.</characteristic>
              </characteristics>
            </profile>
          </profiles>
          <costs>
        ...
        <selectionEntry id="8184-8d7a-d318-18a6" name="Fury of the Ancients" hidden="true" collective="false" import="true" type="upgrade">
          <modifierGroups>
            <modifierGroup>
              <conditions>
                <condition field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="d8c8-9307-fbdc-bba8" type="instanceOf"/>
              </conditions>
              <modifiers>
                <modifier type="set" field="hidden" value="false"/>
                <modifier type="set" field="ceb1-d1d5-dad2-efe7" value="1.0"/>
              </modifiers>
            </modifierGroup>
          </modifierGroups>
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="98bb-3900-4c9f-d523" type="max"/>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="ceb1-d1d5-dad2-efe7" type="min"/>
          </constraints>
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
    ...
    <selectionEntry id="9170-eba7-625a-f5fe" name="Melta grenades" hidden="false" collective="false" import="true" type="upgrade">
      <modifiers>
        <modifier type="add" field="category" value="0b4d-e882-e8a3-7cf3">
          <conditions>
            <condition field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="9170-eba7-625a-f5fe" type="atLeast"/>
          </conditions>
        </modifier>
      </modifiers>
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="0e72-b58c-ee2f-c3fe" type="max"/>
      </constraints>
      <infoLinks>
        <infoLink id="17cd-9e75-c843-499f" name="Melta grenades" hidden="false" targetId="73ad-d9d6-67ea-4313" type="profile"/>
      </infoLinks>
      <categoryLinks>
        <categoryLink id="0605-c7b2-cf84-73fa" name="New CategoryLink" hidden="false" targetId="9927-0892-30f6-d25a" primary="true"/>
        <categoryLink id="421d-98d9-cebc-f11f" name="Stratagem" hidden="false" targetId="3cea-ddab-6257-a5ae" primary="false"/>
      </categoryLinks>
      <costs>
        <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
        <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
    ...
    <selectionEntry id="5434-d176-f43f-ba69" name="Rites of War" hidden="false" collective="false" import="true" type="upgrade">
      <entryLinks>
        <entryLink id="720e-7595-6a0e-a267" name="Rites of War" hidden="false" collective="false" import="true" targetId="f39c-bf02-853e-7d0f" type="selectionEntryGroup"/>
      </entryLinks>
      <costs>
        <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
        <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
    ...
    <selectionEntry id="0188-07ea-eee3-c4c0" name="Fealty" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="e161-1da9-1c90-9348" type="max"/>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="6554-220d-311d-d9e3" type="min"/>
      </constraints>
      <selectionEntryGroups>
        <selectionEntryGroup id="c90d-32ce-ee10-c423" name="Fealty" hidden="false" collective="false" import="true" defaultSelectionEntryId="e66d-9d48-7be2-cba4">
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="e7ca-139c-7c53-7cd3" type="max"/>
          </constraints>
          <selectionEntries>
            <selectionEntry id="e66d-9d48-7be2-cba4" name="Loyalist" hidden="false" collective="false" import="true" type="upgrade"/>
            <selectionEntry id="67e9-5827-4a77-f8a0" name="Traitor" hidden="false" collective="false" import="true" type="upgrade"/>
          </selectionEntries>
        </selectionEntryGroup>
      </selectionEntryGroups>
    </selectionEntry>
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup id="f39c-bf02-853e-7d0f" name="Rites of War" hidden="false" collective="false" import="true">
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="acb1-4edf-6023-7aeb" type="max"/>
      </constraints>
      <selectionEntries>
        <selectionEntry id="e8c9-9fdb-44c9-c0be" name="Angel&apos;s Wrath" hidden="true" collective="false" import="true" type="upgrade">
          <modifiers>
            <modifier type="set" field="hidden" value="false">
              <conditionGroups>
                <conditionGroup type="or">
          ...
          <profiles>
            <profile id="75d2-406d-dbf5-c75b" name="Angel&apos;s Wrath" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
              <characteristics>
                <characteristic name="Ability" typeId="3117-79f3-eb21-c725">Flyers in this detachment can re-roll 1s to hit in the Shooting phase when targeting units that don’t have the FLY keyword.
...
All units in this detachment must have the FLY keyword, or be capable of being transported in a VEHICLE with the FLY keyword.</characteristic>
            ...
            <profile id="7116-e9f0-66a2-5fc9" name="Hit &amp; Run" hidden="false" typeId="8e66-667e-e09b-c25b" typeName="Stratagem">
              <characteristics>
        ...
        <selectionEntry id="e029-7ae0-244b-9a59" name="Armoured Breakthrough" hidden="true" collective="false" import="true" type="upgrade">
          <modifiers>
            <modifier type="set" field="hidden" value="false">
              <conditions>
                <condition field="selections" scope="force" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="37d4-24b9-b237-2453" type="instanceOf"/>
          ...
          <profiles>
            <profile id="1520-90d1-b1c5-4dcb" name="Armoured Breakthrough" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
              <characteristics>
                <characteristic name="Ability" typeId="3117-79f3-eb21-c725">In the first battle round, VEHICLES in this detachment may move with Advance and fire heavy weapons.
...
This detachment must have more VEHICLES without the FLY  keyword than with it.</characteristic>
        ...
        <selectionEntry id="d125-3936-dc14-6a13" name="Armoured Spearhead" hidden="true" collective="false" import="true" type="upgrade">
          <modifiers>
            <modifier type="set" field="hidden" value="false">
              <conditionGroups>
                <conditionGroup type="or">
          ...
          <profiles>
            <profile id="9d60-f7f1-686d-30a0" name="Armoured Spearhead" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
              <characteristics>
                <characteristic name="Ability" typeId="3117-79f3-eb21-c725">VEHICLES in this detachment get +1 to Hit in the Fight phase.
...
All INFANTRY in this detachment must be capable of being transported by a v eHicle and must begin the game embarked within vehicles.</characteristic>
        ...
        <selectionEntry id="0554-b331-5f6e-48e5" name="Brethren of Iron" hidden="true" collective="false" import="true" type="upgrade">
          <modifiers>
            <modifier type="set" field="hidden" value="false">
              <conditionGroups>
                <conditionGroup type="or">
        ...
        <selectionEntry id="9c50-f1de-0392-39a3" name="Drop Assault Vanguard" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="6114-3185-1e28-3f53" name="Fury of the Ancients" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="9ba3-a41f-559b-4e49" name="Orbital Assault" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="b73e-d941-d299-d0e8" name="Orphans of Betrayal" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="f459-d832-f7f2-f2e8" name="Outcast Sons" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="52ae-00e0-3270-b43e" name="Pride of the Legion" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="94a0-53c6-6b54-aa7d" name="Primarch&apos;s Chosen" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="9d42-77f3-447e-b701" name="Recon Company" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="3cc3-30d3-d25a-5586" name="Sacrificial Offering" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="ecb8-4ef4-7804-78f4" name="Sky Hunter Phallanx" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
        ...
        <selectionEntry id="2386-7499-5cf4-e21b" name="Zone Mortalis Assault Force" hidden="false" collective="false" import="true" type="upgrade">
          <costs>
            <cost name="pts" typeId="9484-733c-9847-f18b" value="0.0"/>
            <cost name="CP" typeId="1fac-937b-7466-575c" value="0.0"/>
            <cost name="PL" typeId="b1e1-0497-949d-68af" value="0.0"/>
  ...
  <sharedProfiles>
    <profile id="26e4-c01e-24f3-31ed" name="Explodes (6&quot;/D3)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 6” suffers D3 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="ace7-d3c6-c6b2-384c" name="Explodes (6&quot;/D6)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 6” suffers D6 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="5229-c6aa-a1fe-c7a3" name="Objective Secured" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">This unit has the following abilities: Objective Secured.</characteristic>
      </characteristics>
    </profile>
    ...
    <profile id="73ad-d9d6-67ea-4313" name="Melta grenades" hidden="false" typeId="8e66-667e-e09b-c25b" typeName="Stratagem">
      <modifiers>
        <modifier type="set" field="7175-d70f-ddef-26a3" value="0.0">
          <conditions>
            <condition field="selections" scope="ancestor" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="d3aa-7976-a889-502d" type="instanceOf"/>
      ...
      <characteristics>
        <characteristic name="CP" typeId="7175-d70f-ddef-26a3">1</characteristic>
        <characteristic name="Effect" typeId="9730-e613-daf9-9aa7">You can use this Stratagem just before a friendly model with MELTA GRENADES keyword from your army attacks a unit that has VEHICLE keyword in the Fight phase. You only make a single hit roll this phase; if it hits, the targets suffers 2D3 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="3822-1f21-441e-6c57" name="Explodes (3&quot;/D3)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 3” suffers D3 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="0bcb-4fc4-74ea-7d50" name="Explodes (3&quot;/1)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If a model in this unit is reduced to 0 wounds, roll a D6 before removing it from the battlefield. On a 6 it explodes, and each unit within 3” suffers a mortal wound.</characteristic>
      </characteristics>
    </profile>
    <profile id="8fe0-685b-49f2-b445" name="Explodes (6&quot;/1)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 6” suffers 1 mortal wound.</characteristic>
      </characteristics>
    </profile>
    <profile id="6679-784f-b7b8-4625" name="Immobile" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">This model cannot move for any reason, nor can it fight in the Fight phase. Enemy models automatically hit this model in the Fight phase - do not make hit rolls. However,this model can still shoot if there are enemy models within 1” of it, and friendly units can still target enemy models that are within 1” of this model.</characteristic>
      </characteristics>
    </profile>
    <profile id="ebac-5869-40dd-e398" name="Explodes (2D6&quot;/D6)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield and before any embarked models disembark. On a 6 it explodes, and each unit within 6” suffers 2D6 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="24f5-5073-7411-2c5f" name="Explodes (9&quot;/D3+1)" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield. On a 6 it explodes, and each unit within 9” suffers D3+1 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="a5ab-4afc-4060-1af3" name="Crash and Burn" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">If this model is reduced to 0 wounds, roll a D6 before removing it from the battlefield; on a 6 it crashes and explodes, and each unit within 6” suffers D3 mortal wounds.</characteristic>
      </characteristics>
    </profile>
    <profile id="74f3-0579-d90e-6db8" name="Airborne" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">This model cannot charge, can only be charged by units that can FLY, and can only attack or be attacked in the Fight phase by units that can FLY.</characteristic>
      </characteristics>
    </profile>
    <profile id="5b28-41db-ad2d-73f1" name="Supersonic" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">Each time this model moves first pivot it on the spot up to 90° (this does not contribute to how far the model moves), and then move the model straight forwards. Note that it cannot pivot again after the initial pivot. When this model Advances increase its Move Characteristic by 20” until the end of the phase - do not roll a dice.</characteristic>
      </characteristics>
    </profile>
    <profile id="533c-8c03-15b0-9989" name="Hard to Hit" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="3117-79f3-eb21-c725">Your opponent must subtract 1 from hit rolls for attacks that target this model in the Shooting phase.</characteristic>
      </characteristics>
    </profile>
  </sharedProfiles>
  <sharedInfoGroups>
