...
<gameSystem id="218d-602b-768b-7f56" name="WH30k Fan made 9th Edition" revision="2" battleScribeVersion="2.03" authorName="Lothar" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <sharedProfiles>
    ...
    <profile id="5229-c6aa-a1fe-c7a3" name="Objective Secured" hidden="false" typeId="2324-ae93-2fea-0b85" typeName="Ability">
      <characteristics>
        <characteristic name="Effect" typeId="3117-79f3-eb21-c725">If this unit is within range of an objective marker (as specified in the mission), it controls the objective marker even if there are more enemy models within range of that objective marker.</characteristic>
      </characteristics>
    </profile>
